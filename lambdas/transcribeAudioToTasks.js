      ...
      messages: [
        {
          ...
          "content": `
                ...
                If the user cites date and/or time information within a task, remove referral to the date/time from the task and cite it in the JSON fields below.
                If they mention only a time in their task, assume the scheduled date is the current date.
                If they don't mention a time in their task, leave the field null in the JSON output.
                  ...
                  "tasks": [
                    {
                      ...
                      "scheduled_date": <SQL Date string per rules above>,
                      "scheduled_time": <String in HH:mm format if specified, null otherwise>
                  ]
                }`
        },
